def inverse_carry(quantum_instance, step, bit0, bit1, bit2, bit3):
...
if __name__ == '__main__':
	...
	inverse_carry(quantum_instance, step=0, bit0=0, bit1=1, bit2=2, bit3=3)
	inverse_carry(quantum_instance, step=4, bit0=3, bit1=2, bit2=1, bit3=0)