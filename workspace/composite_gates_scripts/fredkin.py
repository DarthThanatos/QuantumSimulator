def fredkin_gate(quantum_instance, step, ctrl, bit0, bit1):
...
if __name__ == '__main__':
	...
	fredkin_gate(quantum_instance, step=0, ctrl=0, bit0=1, bit1=2)
	fredkin_gate(quantum_instance, step=9, ctrl=2, bit0=1, bit1=0)