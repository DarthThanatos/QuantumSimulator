# run with a conda environment py_3_4 (with python 3.4 installed and gtk+3... checked in the pygi-aio setup).
# do not worry if Pycharm signalizes errors saying gi.repository does not contain Gtk, Gdk and GdkPixbuf, it compiles nonetheless
